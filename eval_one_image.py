...
if __name__ == '__main__':
    ...
    IR_path = "./HMIFDatasets/SPECT-MRI/test/SPECT"
    VIS_path = "./HMIFDatasets/SPECT-MRI/test/MRI"
    Fuse_path = "./result/W-HSSF/SPECT-MRI"
    result_path = 'result/W-HSSF/score/SPECT-MRI'
    ...
    # 将结果保存到CSV文件
    csv_file_path = os.path.join(result_path, 'SPECT_evaluation_results.csv')
