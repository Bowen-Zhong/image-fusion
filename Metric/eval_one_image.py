...
if __name__ == '__main__':
    ...
    Fuse_path = "../result/ASFE_ADD_SSMdeepconv/PET"
    result_path = '../assessment_indexes/ASFE_ADD_SSMdeepconv/PET-MRI'
    ...
    # 将结果保存到CSV文件
    csv_file_path = os.path.join(result_path, 'evaluation_results_{}.csv')
